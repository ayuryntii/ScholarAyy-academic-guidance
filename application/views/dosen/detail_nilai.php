                ...
                <div class="card">
                     <div class="card-body">
                          <button type="button" class="btn btn-primary text-white float-right" data-toggle="modal"
                               data-target="#tambahModal"><i class="fa fa-plus"></i>Tambah Nilai</button>
                          ...
                          <br>
                          <button type="button" class="btn btn-info btn-xs text-white" data-toggle="modal"
                          ...
                          <div class="modal-body">
                               <form>
                                    <div class="form-group">
                                         <label for="recipient-name" class="col-form-label">Nilai Bimbingan
                                              Proyek</label>
