...
<div class="dashboard-wrapper">
     <div class="container-fluid dashboard-content">
        ...
        $tanggal_pengumpulan = '';
        if (isset($user_data) && !empty($user_data) && isset($user_data['tanggal_pengumpulan_proposal'])) {
            $tanggal_pengumpulan = $user_data['tanggal_pengumpulan_proposal'];
        }
                         ...
                         <div class="card-body">
                              <table class="table table-bordered">
                                   ...
                                   <tbody>
                                        ...
                                        <?php 
                                        $setatus = $this->db->get_where('status_proposal', ['id' => $mhs2['status_proposal_id']])->row_array();
                                        ...
                                        <tr class="text-center">
                                             ...
                                             <td width="100" rowspan="2">
                                                  <a href="<?= base_url('cordinator/detailproposal/') . $mhs2['user_id'] ?>"
                              ...
                              <div class="modal-content">
                                   ...
                                   <div class="modal-body">
                                        <form class="user" method="post"
                                             action="<?= base_url('cordinator/tambah_proposal') ?>">
                                             <div class="form-group">
                                                  <label for="tanggal_pengumpulan_proposal" class="col-form-label">Batas
                                                       Waktu</label>
                                                  <input type="date" name="tanggal_pengumpulan_proposal"
                                                       class="form-control" id="tanggal_pengumpulan_proposal" required>
                                             </div>
                                   </div>
