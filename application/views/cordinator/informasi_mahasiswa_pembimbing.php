                ...
                <div class="card">
                     <div class="card-body">
                          <button type="button" class="btn btn-primary text-white float-right" data-toggle="modal"
                               data-target="#tambahModal"><i class="fa fa-plus"></i> Tambah Data Mahasiswa
                               Aktif</button>
                          ...
                          <table class="table table-bordered" id="table">
                               ...
                               <tbody>
                                    ...
                                    <tr class="text-center">
                                         ...
                                         <td><?= $dos['status']; ?></td>
                                         <td width="160">
                                              <a href="<?= base_url('cordinator/edit_mhs/') ?><?= $dos['id'] ?>"
                                                   class="btn btn-info btn-xs text-white" data-toggle="modal"
                                                   data-target="#editModal<?= $dos['id'] ?>"><i class="fas fa-edit"></i>
                                                   Edit</a>
                                              <a href="<?= base_url('cordinator/hapus_mhs/') ?><?= $dos['id'] ?>"
                               ...
                               <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                         <form class="user" method="post"
                                              action="<?= base_url('cordinator/registration_mhs') ?>">
                                              ...
                                              <div class="form-group">
                                                   ...
                                                   <select class="form-control" id="kelas" name="kelas">
                                                        ...
                                                        <option value="D3 Teknik Informatika 2A">D3 Teknik Informatika
                                                             2A</option>
                                                        <option value="D3 Teknik Informatika 2B">D3 Teknik Informatika
                                                             2B</option>
                                                        <option value="D3 Teknik Informatika 3A">D3 Teknik Informatika
                                                             3A</option>
                                                   </select>
                                              </div>
                                              <div class="form-group">
                                                   ...
                                                   <select class="form-control" id="status" name="status">
                                                        ...
                                                        <option value="Mahasiswa Tidak Aktif">Mahasiswa Tidak Aktif
                                                        </option>
                                                   </select>
                                              </div>
                                    </div>
                     ...
                     <div class="modal fade" id="editModal<?= $ts['id'] ?>" tabindex="-1"
                          ...
                          <div class="modal-dialog">
                               <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                         <form class="user" method="post"
                                              action="<?= base_url('cordinator/edit_mhs/') ?><?= $ts['id'] ?>">
                                              <div class="form-group">
                                                   <label for="npm" class="col-form-label">NIM</label>
                                                   <input type="number" name="npm" class="form-control" id="npm"
                                                        placeholder="Npm" value="<?= $ts['npm']; ?>">
                                              </div>
                                              <div class="form-group">
                                                   <label for="name_ds" class="col-form-label">Nama</label>
                                                   <input type="text" name="name" class="form-control" id="name_ds"
                                                        placeholder="Nama" value="<?= $ts['name']; ?>">
                                              </div>
                                              <div class="form-group">
                                                   <label for="name_ds" class="col-form-label">Kelas</label>
                                                   <select class="form-control" id="kelas" name="kelas">
                                                        <option value="<?= $ts['kelas']; ?>"><?= $ts['kelas']; ?>
                                                        </option>
                                                        <option value="D3 Teknik Informatika 2A">TI23A/option>
                                                        <option value="D3 Teknik Informatika 2B">TI23B</option>
                                                        <option value="D3 Teknik Informatika 3A">TI23C</option>
                                                   </select>
                                              </div>
                                              <div class="form-group">
                                                   <label for="name_ds" class="col-form-label">Status</label>
                                                   <select class="form-control" id="status" name="status">
                                                        <option value="<?= $ts['status']; ?>"><?= $ts['status']; ?>
                                                        </option>
                                                        <option value="Mahasiswa Aktif">Mahasiswa Aktif</option>
                                                        <option value="Mahasiswa Tidak Aktif">Mahasiswa Tidak Aktif
                                                        </option>
