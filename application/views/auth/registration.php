              ...
              <div class="col-7">
                   <div class="card">
                             ...
                             <div class="card-body">
                                  <div class="form-group">
                                       <input class="form-control form-control-lg" type="text" name="name_mhs_1"
                                            value="<?= set_value('name_mhs_1') ?>" placeholder="Nama Mahasiswa 1"
                                            autocomplete="off">
                                  ...
                                  <div class="form-group">
                                       <input class="form-control form-control-lg" type="text" name="npm_mhs_1"
                                            value="<?= set_value('npm_mhs_1') ?>" placeholder="NIM Mahasiswa 1"
                                            autocomplete="off">
                                       <?= form_error('npm_mhs_1', '<small class="text-danger pl-3">', '</small>'); ?>
                                  </div>
                                  <div class="form-group">
                                       <select class="form-control" value="<?= set_value('kelas_mhs_1') ?>"
                                            id="kelas_mhs_1" name="kelas_mhs_1">
                                            <option disabled selected value>Kelas</option>
                                            <option value="TI23A">TI23A</option>
                                            <option value="TI23B">TI23B</option>
                                            <option value="TI23C">TI23C</option>
                                       </select>
                                  ...
                                  <div class="form-group">
                                       <input class="form-control form-control-lg" type="text" name="name_mhs_2"
                                            value="<?= set_value('name_mhs_2') ?>" placeholder="Nama Mahasiswa 2"
                                            autocomplete="off">
                                  ...
                                  <div class="form-group">
                                       <input class="form-control form-control-lg" type="text" name="npm_mhs_2"
                                            value="<?= set_value('npm_mhs_2') ?>" placeholder="NIM Mahasiswa 2"
                                            autocomplete="off">
                                       <?= form_error('npm_mhs_2', '<small class="text-danger pl-3">', '</small>'); ?>
                                  </div>
                                  <div class="form-group">
                                       <select class="form-control" value="<?= set_value('kelas_mhs_2') ?>"
                                            id="kelas_mhs_2" name="kelas_mhs_2">
                                            <option disabled selected value>Kelas</option>
                                            <option value="TI23A">TI23A</option>
                                            <option value="TI23B">TI23B</option>
                                            <option value="TI23C">TI23C</option>
                                  ...
                                  <div class="form-group">
                                       <input class="form-control form-control-lg" type="text" readonly
                                            name="katagori_proyek" value="Proyek 2" placeholder="katagori proyek"
                                            autocomplete="off">
                        ...
                        <div class="card-footer bg-white text-center">
                             ...
                             <p>Developed by : <a href="https://github.com/ayuryntii" class="text-success">Ayuryntii</a>
                             </p>
                        </div>
                   </div>
              </div>
